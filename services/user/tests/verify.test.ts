...
describe('inter-service verify helper (user)', () => {
...
describe('auth middleware outbound /me signing (user)', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    mockedAxios.get.mockResolvedValue({
      data: { data: { id: 'u1', email: 'u@example.com', role: 'user', sellerStatus: 'NONE' } },
    } as never);
  });
