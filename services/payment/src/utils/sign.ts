...
/**
 * Inter-service HMAC signing. Used by payment-service when it calls
 * other services directly (e.g. payment → order to fetch order
 * details before processing). Algorithm MUST match
